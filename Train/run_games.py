...
def run_match(best, root_dir, c_chess_exe, concurrency, book_file_name, engine):
    ...
    command = "{} -each tc=10+0.1 -games 10 -rounds 2 -concurrency {}".format(
    ...
    command = command + " -engine cmd=/ssd2/Minic/Dist/Minic3/3.36/minic_3.36_linux_x64_skylake name=master"
