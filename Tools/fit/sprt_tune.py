...
def build_arg_parser():
    ...
    p_tune.add_argument("--elo1", type=float, default=3.0, help="H0: the change does not gain this many elo")
    p_tune.add_argument("--alpha", type=float, default=0.1, help="Type I error rate")
    p_tune.add_argument("--beta", type=float, default=0.1, help="Type II error rate")
