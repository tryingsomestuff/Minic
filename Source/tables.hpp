...
struct HistoryT{
    ScoreType history[2][64][64] = {0}; // color, from, to
    ScoreType historyP[13][64] = {0}; // Piece, to
    ScoreType counter_history[13][64][13*64] = {0}; //previous moved piece, previous to, current moved piece * boardsize + current to
