...
const std::string TimerNames[TM_Max] = { "Total", "See", "Apply", "Eval1", "Eval2", "Eval3", "Eval4", "Eval5", "Eval", 
                                         "Attack", "MovePiece", "Generate", "PseudoLegal", "IsAttacked", "MoveScoring", "MoveSorting"};
