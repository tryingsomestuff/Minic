...
template<typename C>
void addOptions(C & coeff){
   for (size_t k = 0; k < coeff.N; ++k){
      _keys.emplace_back(k_depth, w_spin, coeff.getName(SearchConfig::CNT_minDepth,k), &coeff.minDepth[k]       , DepthType(0)     , DepthType(MAX_DEPTH)  );
      _keys.emplace_back(k_depth, w_spin, coeff.getName(SearchConfig::CNT_maxdepth,k), &coeff.maxDepth[k]       , DepthType(0)     , DepthType(MAX_DEPTH)  );
      _keys.emplace_back(k_score, w_spin, coeff.getName(SearchConfig::CNT_slopeD,k)  , &coeff.slopeDepth[k]     , ScoreType(-1500) , ScoreType(1500));
      _keys.emplace_back(k_score, w_spin, coeff.getName(SearchConfig::CNT_slopeGP,k) , &coeff.slopeGamePhase[k] , ScoreType(-1500) , ScoreType(1500));
      _keys.emplace_back(k_score, w_spin, coeff.getName(SearchConfig::CNT_init,k)    , &coeff.init[k]           , ScoreType(-1500) , ScoreType(1500));
   }
   for (size_t k = 0; k < coeff.M; ++k){
      _keys.emplace_back(k_score, w_spin, coeff.getName(SearchConfig::CNT_bonus,k)   , &coeff.bonus[k]          , ScoreType(-1500) , ScoreType(1500));
   }
}
...
void registerCOMOptions() { // options exposed to GUI
   ...
   _keys.emplace_back(k_int,   w_spin,  "Level"                       , &DynamicConfig::level                          , (unsigned int)0  , (unsigned int)100);
   _keys.emplace_back(k_bool,  w_check, "nodesBasedLevel"             , &DynamicConfig::nodesBasedLevel                , false            , true);
   ...
   _keys.emplace_back(k_bool,  w_check, "MateFinder"                  , &DynamicConfig::mateFinder                     , false            , true);
   _keys.emplace_back(k_int,   w_spin,  "MultiPV"                     , &DynamicConfig::multiPV                        , (unsigned int)1  , (unsigned int)4);
   _keys.emplace_back(k_int,   w_spin,  "RandomOpen"                  , &DynamicConfig::randomOpen                     , (unsigned int)0  , (unsigned int)100);
   _keys.emplace_back(k_int,   w_spin,  "MinMoveOverHead"             , &DynamicConfig::moveOverHead                   , (unsigned int)10 , (unsigned int)1000);
   _keys.emplace_back(k_score, w_spin,  "Contempt"                    , &DynamicConfig::contempt                       , (ScoreType)-50   , (ScoreType)50);
   _keys.emplace_back(k_score, w_spin,  "ContemptMG"                  , &DynamicConfig::contemptMG                     , (ScoreType)-50   , (ScoreType)50);
   _keys.emplace_back(k_bool,  w_check, "Armageddon"                  , &DynamicConfig::armageddon                     , false            , true);
   _keys.emplace_back(k_bool,  w_check, "AntiChess"                   , &DynamicConfig::antichess                      , false            , true);
   ...
   _keys.emplace_back(k_int,   w_spin,  "NNUEThresholdEG"             , &DynamicConfig::NNUEThresholdEG                , (int)0           , (int)1500);
   _keys.emplace_back(k_int,   w_spin,  "NNUEThreshold2"              , &DynamicConfig::NNUEThreshold2                 , (int)0           , (int)1500);
   _keys.emplace_back(k_int,   w_spin,  "NNUEThreshold2EG"            , &DynamicConfig::NNUEThreshold2EG               , (int)0           , (int)1500);
#endif

#ifdef WITH_GENFILE
   _keys.emplace_back(k_bool,  w_check, "GenFen"                      , &DynamicConfig::genFen                         , false            , true);
   _keys.emplace_back(k_bool,  w_check, "PgnOut"                      , &DynamicConfig::pgnOut                         , false            , true);
   _keys.emplace_back(k_int,   w_spin,  "GenFenDepth"                 , &DynamicConfig::genFenDepth                    , (unsigned int)2  , (unsigned int)40);
   _keys.emplace_back(k_int,   w_spin,  "GenFenDepthEG"               , &DynamicConfig::genFenDepthEG                  , (unsigned int)2  , (unsigned int)40);
   _keys.emplace_back(k_int,   w_spin,  "RandomPly"                   , &DynamicConfig::randomPly                      , (unsigned int)0  , (unsigned int)40);
   //_keys.emplace_back(k_ull,   w_spin,  "MaxNodes"                    , &TimeMan::maxNodes                             , (uint64_t)0      , (uint64_t)100000000);
#endif

   _keys.emplace_back(k_int,   w_spin,  "StyleAttack"                 , &DynamicConfig::styleAttack                    , (int)0   , (int)100                                    , &EvalFeatures::callBack);
   _keys.emplace_back(k_int,   w_spin,  "StyleComplexity"             , &DynamicConfig::styleComplexity                , (int)0   , (int)100                                    , &EvalFeatures::callBack);
   _keys.emplace_back(k_int,   w_spin,  "StyleDevelopment"            , &DynamicConfig::styleDevelopment               , (int)0   , (int)100                                    , &EvalFeatures::callBack);
   _keys.emplace_back(k_int,   w_spin,  "StyleMaterial"               , &DynamicConfig::styleMaterial                  , (int)0   , (int)100                                    , &EvalFeatures::callBack);
   _keys.emplace_back(k_int,   w_spin,  "StyleMobility"               , &DynamicConfig::styleMobility                  , (int)0   , (int)100                                    , &EvalFeatures::callBack);
   _keys.emplace_back(k_int,   w_spin,  "StylePositional"             , &DynamicConfig::stylePositional                , (int)0   , (int)100                                    , &EvalFeatures::callBack);
   _keys.emplace_back(k_int,   w_spin,  "StyleForwardness"            , &DynamicConfig::styleForwardness               , (int)0   , (int)100                                    , &EvalFeatures::callBack);

   _keys.emplace_back(k_string, w_string,"UCI_Opponent"               , &DynamicConfig::opponent                                                                                /*, &Opponent::init*/);
   _keys.emplace_back(k_int,    w_spin,  "UCI_RatingAdv"              , &DynamicConfig::ratingAdv                      , (int)-10000, (int)10000                                , &Opponent::ratingReceived);

   _keys.emplace_back(k_string, w_combo, "UCI_Variant"                , &DynamicConfig::chessvariant                   , std::vector<std::string>{ "chess", "antichess", "armageddon", "fischerandom"}  , &UCI::handleVariant);

#ifdef WITH_SEARCH_TUNING

   _keys.emplace_back(k_depth, w_spin, "aspirationMinDepth"                , &SearchConfig::aspirationMinDepth                  , DepthType(0)    , DepthType(30)      );
   _keys.emplace_back(k_score, w_spin, "aspirationInit"                    , &SearchConfig::aspirationInit                      , ScoreType(0)    , ScoreType(30)      );
   _keys.emplace_back(k_score, w_spin, "aspirationDepthInit"               , &SearchConfig::aspirationDepthInit                 , ScoreType(-150) , ScoreType(150)     );
   _keys.emplace_back(k_score, w_spin, "aspirationDepthCoef"               , &SearchConfig::aspirationDepthCoef                 , ScoreType(-10)  , ScoreType(10)      );

   _keys.emplace_back(k_score, w_spin, "qfutilityMargin0"                  , &SearchConfig::qfutilityMargin[0]                  , ScoreType(-200) , ScoreType(1500)    );
   _keys.emplace_back(k_score, w_spin, "qfutilityMargin1"                  , &SearchConfig::qfutilityMargin[1]                  , ScoreType(-200) , ScoreType(1500)    );

   _keys.emplace_back(k_depth, w_spin, "nullMoveMinDepth"                  , &SearchConfig::nullMoveMinDepth                    , DepthType(0)    , DepthType(30)      );
   _keys.emplace_back(k_depth, w_spin, "nullMoveVerifDepth"                , &SearchConfig::nullMoveVerifDepth                  , DepthType(0)    , DepthType(30)      );
   _keys.emplace_back(k_score, w_spin, "nullMoveMargin"                    , &SearchConfig::nullMoveMargin                      , ScoreType(-500) , ScoreType(500)     );
   _keys.emplace_back(k_score, w_spin, "nullMoveMargin2"                   , &SearchConfig::nullMoveMargin2                     , ScoreType(-500) , ScoreType(500)     );
   _keys.emplace_back(k_score, w_spin, "nullMoveReductionInit"             , &SearchConfig::nullMoveReductionInit               , ScoreType(1)    , ScoreType(10)      );
   _keys.emplace_back(k_score, w_spin, "nullMoveReductionDepthDivisor"     , &SearchConfig::nullMoveReductionDepthDivisor       , ScoreType(1)    , ScoreType(10)      );
   _keys.emplace_back(k_score, w_spin, "nullMoveDynamicDivisor"            , &SearchConfig::nullMoveDynamicDivisor              , ScoreType(1)    , ScoreType(1500)    );
   ...
   _keys.emplace_back(k_depth, w_spin, "iidMinDepth2"                      , &SearchConfig::iidMinDepth2                        , DepthType(0)    , DepthType(30)      );
   _keys.emplace_back(k_depth, w_spin, "iidMinDepth3"                      , &SearchConfig::iidMinDepth3                        , DepthType(0)    , DepthType(30)      );
   _keys.emplace_back(k_depth, w_spin, "probCutMinDepth"                   , &SearchConfig::probCutMinDepth                     , DepthType(0)    , DepthType(30)      );
   ...
   _keys.emplace_back(k_score, w_spin, "seeQuietFactor"                    , &SearchConfig::seeQuietFactor                      , ScoreType(0)    , ScoreType(1500)    );
   _keys.emplace_back(k_score, w_spin, "seeQuietInit"                      , &SearchConfig::seeQuietInit                        , ScoreType(-500) , ScoreType(500)     );
   _keys.emplace_back(k_score, w_spin, "seeQuietDangerDivisor"             , &SearchConfig::seeQuietDangerDivisor               , ScoreType(1)    , ScoreType(32)      );
   _keys.emplace_back(k_score, w_spin, "seeQThreshold"                     , &SearchConfig::seeQThreshold                       , ScoreType(-200) , ScoreType(200)     );
   _keys.emplace_back(k_score, w_spin, "betaMarginDynamicHistory"          , &SearchConfig::betaMarginDynamicHistory            , ScoreType(0)    , ScoreType(1500)    );

   _keys.emplace_back(k_depth, w_spin, "lmrMinDepth"                       , &SearchConfig::lmrMinDepth                         , DepthType(0)    , DepthType(30)      );
   _keys.emplace_back(k_depth, w_spin, "singularExtensionDepth"            , &SearchConfig::singularExtensionDepth              , DepthType(0)    , DepthType(30)      );
   _keys.emplace_back(k_depth, w_spin, "singularExtensionDepthMinus"       , &SearchConfig::singularExtensionDepthMinus         , DepthType(1)    , DepthType(30)      );
   
   _keys.emplace_back(k_int  , w_spin, "lmrCapHistoryFactor"               , &SearchConfig::lmrCapHistoryFactor                 , 1               , 64                 );

   _keys.emplace_back(k_score, w_spin, "dangerLimitPruning"                , &SearchConfig::dangerLimitPruning                  , ScoreType(0)    , ScoreType(65)      );
   _keys.emplace_back(k_score, w_spin, "dangerLimitForwardPruning"         , &SearchConfig::dangerLimitForwardPruning           , ScoreType(0)    , ScoreType(65)      );
   _keys.emplace_back(k_score, w_spin, "dangerLimitReduction"              , &SearchConfig::dangerLimitReduction                , ScoreType(0)    , ScoreType(65)      );
   ...
   _keys.emplace_back(k_score, w_spin, "PawnValueMG"   , &Values  [P_wp+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "PawnValueEG"   , &ValuesEG[P_wp+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "PawnValueGP"   , &ValuesGP[P_wp+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "PawnValueSEE"  , &ValuesSEE[P_wp+PieceShift] , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));

   _keys.emplace_back(k_score, w_spin, "KnightValueMG" , &Values  [P_wn+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "KnightValueEG" , &ValuesEG[P_wn+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "KnightValueGP" , &ValuesGP[P_wn+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "KnightValueSEE", &ValuesSEE[P_wn+PieceShift] , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));

   _keys.emplace_back(k_score, w_spin, "BishopValueMG" , &Values  [P_wb+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "BishopValueEG" , &ValuesEG[P_wb+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "BishopValueGP" , &ValuesGP[P_wb+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "BishopValueSEE", &ValuesSEE[P_wb+PieceShift] , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));

   _keys.emplace_back(k_score, w_spin, "RookValueMG"   , &Values  [P_wr+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "RookValueEG"   , &ValuesEG[P_wr+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "RookValueGP"   , &ValuesGP[P_wr+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "RookValueSEE"  , &ValuesSEE[P_wr+PieceShift] , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));

   _keys.emplace_back(k_score, w_spin, "QueenValueMG"  , &Values  [P_wq+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "QueenValueEG"  , &ValuesEG[P_wq+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "QueenValueGP"  , &ValuesGP[P_wq+PieceShift]  , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
   _keys.emplace_back(k_score, w_spin, "QueenValueSEE" , &ValuesSEE[P_wq+PieceShift] , ScoreType(0)    , ScoreType(2000)     ,  [](){SymetrizeValue(); MaterialHash::InitMaterialScore(false);}));
#endif
...
#define GETOPTVAR(name, variable, type) Options::getOption<type>(DynamicConfig::variable, #name);
   ...
   GETOPT(NNUEThresholdEG, int)
   GETOPT(NNUEThreshold2, int)
   GETOPT(NNUEThreshold2EG, int)
#endif
