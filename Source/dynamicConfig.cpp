...
ScoreType    contempt         = 14;
ScoreType    contemptMG       = 9;
...
int NNUEScaling    = 45; // hand tuned
int NNUEThreshold  = 700;
int NNUEThresholdEG = 350;
int NNUEThreshold2 = 150;
int NNUEThreshold2EG = 71;
